...
Function Redirect-Folder {
    ...
    If ($Folder -ne "$SyncFolder\$Target") {
        ...
        Move-Files -Source -Destination "$SyncFolder\$Target" -Log "$env:LocalAppData\RedirectLogs\Robocopy$Target.log"
...
If (Test-Path $Userfolder) {
    ...
    Redirect-Folder -SyncFolder $Userfolder -GetFolder 'Desktop' -SetFolder 'Desktop' -Target 'Desktop'
    Redirect-Folder -SyncFolder $Userfolder -GetFolder 'MyDocuments' -SetFolder 'Documents' -Target 'Documents'
    Redirect-Folder -SyncFolder $Userfolder -GetFolder 'MyPictures' -SetFolder 'Pictures' -Target 'Pictures'
    Redirect-Folder -SyncFolder $Userfolder -GetFolder 'Downloads' -SetFolder 'Downloads' -Target 'Downloads'
}

Move-Item $OneDriveFolder'\Desktop' $userFolder'\Desktop'
Set-ItemProperty -Path $userFolder'\Desktop' -Name Attributes -Value Normal
Move-Item $OneDriveFolder'\Documents' $userFolder'\Documents'
Set-ItemProperty -Path $userFolder'\Documents' -Name Attributes -Value Normal
Move-Item $OneDriveFolder'\Pictures' $userFolder'\Pictures'
Set-ItemProperty -Path $userFolder'\Pictures' -Name Attributes -Value Normal
Move-Item $OneDriveFolder'\Downloads' $userFolder'\Downloads'
Set-ItemProperty -Path $userFolder'\Downloads' -Name Attributes -Value Normal