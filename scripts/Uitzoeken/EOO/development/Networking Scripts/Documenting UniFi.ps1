###############
$UnifiBaseUri = "https://unifi.eoo.cloud:8443/api"
$UnifiUser = "EOO_API_User"
$UnifiPassword = "!Q0xRP7305NIs@%m87#rl8Y%i4Xi%v6O4*pH2T%W0uw9!FJSD0pQ3RxQy9bIiV94uQwo&QPV#MKr5uq"
##############
