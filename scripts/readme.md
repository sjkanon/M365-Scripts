...
| [`Intune/`](Intune/readme.md) | Autopilot hardware hash collection, iOS compliance policy updater |
...
| [`Custom Scripts/`](Custom%20Scripts/readme.md) | Customer-specific tooling — device maintenance, Intune desktop, DNS, SAS monitoring, USB setup toolkit |
