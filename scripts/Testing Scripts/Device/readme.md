...
- Dry-run mode keeps full authentication/bootstrap and export/report flow active, but simulates archive/unarchive mutations in Step 10 with `[DRYRUN]` output.
