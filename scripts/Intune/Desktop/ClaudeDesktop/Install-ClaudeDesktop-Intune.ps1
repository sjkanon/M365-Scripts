<#
.SYNOPSIS
    Intune Win32-app install script voor Claude Desktop (machine-breed).
...
.DESCRIPTION
    ...
    Gaat uitsluitend over Claude Desktop zelf — de Windows-kant van Cowork
    (VirtualMachinePlatform, Fast Startup) is een eigen, onafhankelijke Win32-app, zie
    ../CoworkPrerequisites/readme.md. Dit script heeft daar bewust geen dependency op: Claude
    Desktop werkt prima zonder Cowork, dus een probleem aan de Cowork-kant mag deze installatie
    niet blokkeren.

    Voert uit:
      1. Verwijdert Claude Desktop VOLLEDIG van dit apparaat vóór de nieuwe installatie: sluit
      ...
      2. Add-AppxProvisionedPackage voor machine-brede installatie van de nieuwe versie (bereikt
...
try {
    ...
    # 1. Claude Desktop volledig verwijderen vóór de nieuwe installatie (zie .DESCRIPTION)
    ...
    #    niet via Claude's eigen updater (die zou de machine-brede provisioning per-user kunnen
    #    overschrijven — zie support.claude.com "Enterprise configuration for Claude Desktop")
